                ...
                <div className="flex-1 px-8 py-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-4">
                    <div>
                      ...
                      <Input value={nome} onChange={e => setNome(e.target.value)} className="h-10 bg-[#F5F5F5] border-none rounded-md text-sm" placeholder="Exemplo: João da Silva Santos" />
                    </div>
                    <div>
                    ...
                    <div>
                      <label className="block text-sm font-normal text-black mb-1 font-sans">Telefone:</label>
                      <Input value={telefone} onChange={e => setTelefone(e.target.value)} className="h-10 bg-[#F5F5F5] border-none rounded-md text-sm" placeholder="Exemplo: 61990909090" />
                    </div>
                  </div>
                  <div className="grid grid-cols-3 gap-4 mb-8">
                    <div>
                      <label className="block text-sm font-normal text-black mb-1 font-sans">Data de Nascimento:</label>
                      <Input value={nascimento} onChange={e => setNascimento(e.target.value)} className="h-10 bg-[#F5F5F5] border-none rounded-md text-sm" placeholder="Exemplo: 01/08/1990" />
                    </div>
                    <div className="col-span-2">
                      <label className="block text-sm font-normal text-black mb-1 font-sans">Nome da mãe:</label>
                      <Input value={nomeMae} onChange={e => setNomeMae(e.target.value)} className="h-10 bg-[#F5F5F5] border-none rounded-md text-sm" placeholder="Exemplo: Joana da Silva Santos" />
                    </div>
                  </div>
                  <div className="mb-6">
                  ...
                  <TemporaryDataTable
                    headers={["Nome", "CPF", "Telefone", "Nascimento", "Nome da Mãe"]}
                    data={tableData}
