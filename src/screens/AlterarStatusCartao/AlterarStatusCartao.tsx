...
export const AlterarStatusCartao = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-[#F0F2F5]">
      {/* Header with Vale Shop logo - exact match */}
      <Header />
        ...
        <div className="w-full max-w-[1300px]">
          ...
          <Card className="bg-white rounded-[20px] shadow-md overflow-hidden">
            <CardContent className="p-0">
              <div className="flex">
                {/* Left sidebar navigation - exact gray background */}
                <Nav />
                ...
                <div className="flex-1 px-8 py-6">
                  ...
                  {/* Form fields - first row - exact 3 column layout */}
                  ...
                  {/* Form fields - second row - exact layout */}
                    ...
                    <div>
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Cancealr">Cancelar</SelectItem>
                  ...
                  {/* Register button - exact blue styling */}
