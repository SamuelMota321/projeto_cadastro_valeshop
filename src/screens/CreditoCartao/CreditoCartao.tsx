...
const pageConfigs = {
  ...
  sampleDataGenerator: () => [
    ["", "PLANILHA PARA CRÉDITO DE VALORES PARA CARTÃO"],
    [],
  ...
  downloadFileNamePrefix: "Credito_Cartao",
  instructions: [
...
export const CreditoCartao = (): JSX.Element => {
  const { states, handlers } = useFormAndTable({
    ...
    fileName: pageConfigs.downloadFileNamePrefix,
  });
              ...
              <div className="flex">
                ...
                <form onSubmit={(e) => e.preventDefault()} className="flex-1 px-8 py-6 min-w-0">
                  <h1 className="text-3xl font-normal text-center text-black mb-8 font-sans">
                    Crédito de Valores para Cartão
                  </h1>
